...
class OracleStoneTest {
    ...
    void ordinaryDayAdvancesOnlyTheDayCounter() {
        var stone = new OracleStone(1, 20, false, () -> { throw new AssertionError("should not roll"); });
        stone.updateQuality();
    ...
    void gainsOneQualityOnEveryThirdDay() {
        var stone = new OracleStone(2, 20, false, () -> { throw new AssertionError("should not roll"); });
        stone.updateQuality();
    ...
    void sealedStoneDoesNotGainQualityEvenOnValueUpDays() {
        var stone = new OracleStone(5, 42, true, () -> { throw new AssertionError("should not roll"); });
        stone.updateQuality();
