...
class OracleStoneTest {
    ...
    void ordinaryDayAdvancesOnlyDayCounter() {
        ...
        stone.update();
        assertEquals(2, stone.day); assertEquals(20, stone.quality); assertFalse(stone.sealed);
    }
    ...
    void gainsOneQualityOnEveryThirdDay() {
        ...
        stone.update();
        assertEquals(3, stone.day); assertEquals(21, stone.quality); assertFalse(stone.sealed);
    }
    ...
    void favorableOracleBlessingOnSeventhDayAddsTenQuality() {
        ...
        stone.update();
        assertEquals(7, stone.day); assertEquals(30, stone.quality); assertFalse(stone.sealed);
    }
    ...
    void unfavorableOracleBlessingSealsStoneWithoutChangingQuality() {
        ...
        stone.update();
        assertEquals(7, stone.day); assertEquals(20, stone.quality); assertTrue(stone.sealed);
    }
    ...
    void sealedStoneDoesNotGainQualityEvenOnValueUpDays() {
        ...
        stone.update();
        assertEquals(6, stone.day); assertEquals(42, stone.quality); assertTrue(stone.sealed);
    }
}
