...
class OracleStoneTest {
    ...
    @Test
    void givenUnsealedOracleStoneOnDayBeforeMultipleOfThree_whenDayPasses_thenQualityIncreasedByOne() {
    ...
    @Test
    void givenUnsealedOracleStoneWithFavorableRoll_whenSeventhDayPasses_thenQualityIncreasedByTen() {
    ...
    @Test
    void givenUnsealedOracleStoneWithUnfavorableRoll_whenSeventhDayPasses_thenStoneSealedWithoutQualityChange() {
    ...
    @Test
    void givenSealedOracleStone_whenDayPasses_thenQualityUnchanged() {
