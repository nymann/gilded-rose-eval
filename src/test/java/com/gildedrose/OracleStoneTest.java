...
class OracleStoneTest {
    ...
    void ordinaryDayAdvancesOnlyDayCounter() {
        OracleStone stone = new OracleStone(1, 20, false, () -> { throw new AssertionError("oracle should not be called"); });
        stone.advanceDay();
    ...
    void gainsOneQualityOnEveryThirdDay() {
        OracleStone stone = new OracleStone(2, 20, false, () -> { throw new AssertionError("oracle should not be called"); });
        stone.advanceDay();
    ...
    void sealedStoneDoesNotGainQualityEvenOnValueUpDays() {
        OracleStone stone = new OracleStone(5, 42, true, () -> { throw new AssertionError("oracle should not be called"); });
        stone.advanceDay();
