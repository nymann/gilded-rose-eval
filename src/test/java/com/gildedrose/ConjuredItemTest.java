...
public class ConjuredItemTest {
    ...
    @Test
    void conjuredItemSellInDecreasesBy1EachDay() {
        Item item = new Item("Conjured Mana Cake", 5, 10);
        GildedRose gildedRose = new GildedRose(new Item[]{item});
    ...
    @Test
    void conjuredItemsDegradeInQualityTwiceAsFastAfterSellByDate() {
    ...
    @Test
    void conjuredItemQualityCanNeverGoBelowZero() {
    ...
    @Test
    void conjuredItemQualityCanNeverGoBelowZeroAfterSellByDate() {
